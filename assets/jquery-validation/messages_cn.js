...
function geturlpara(url) {
    ...
    if (urlitems.length > 1) {
        var urlitem2 = urlitems[1].split("&");
        var jsonarr = "";
        $.each(urlitem2, function (n, value) {
            var nv = value.split("=");
            jsonarr += "\"" + nv[0] + "\":\"" + nv[1] + "\",";
        }
        );
